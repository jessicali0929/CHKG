# 《史记》知识图谱 —— 基于实体与关系的历史文本挖掘

## 📜 项目简介

本项目以司马迁所著《史记》为数据源，利用自然语言处理与知识图谱技术，从原文中系统性地抽取**实体**（人物、地点、事件、官职、礼制等）及其之间的**语义关系**，构建了一个结构化的《史记》知识图谱。通过该图谱，研究者与爱好者可以直观探索《史记》中庞杂的人物网络、地理沿革、政治事件以及礼乐星象等文化维度。
